          ...
          <div className="space-y-6">
            <Link to="/" className="inline-block">
              <img
                ...
                src="/lovable-uploads/8b06ebf9-b79a-4441-9151-cb857e520c88.png"
              />
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-400">
              <li className="flex items-start space-x-3">
                ...
                <span>
                  KAIZEN, 2nd & 3rd Floor, New No. G3 (Old No. G1), G Block, Plot No. 565Q,
                  18th Street, Chinthamani, Anna Nagar East, Chennai 600102.
                </span>
              </li>
              <li className="flex items-start space-x-3">
                <MapPin size={20} className="text-primary flex-shrink-0 mt-1" />
