  ...
  return <footer className="bg-gradient-to-b from-gray-900 to-gray-950 text-white relative">
      ...
      <div className="container mx-auto px-4 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-6">
            <Link to="/" className="inline-block">
              <img src="/lovable-uploads/c80361a7-f9e6-4b5d-a689-95904676a926.png" alt="Orange Office Technologies" className="h-12 w-auto bg-white/10 p-2 rounded-lg backdrop-blur-sm" />
            </Link>
        ...
        <div className="w-full mb-12 rounded-xl overflow-hidden shadow-lg">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3886.1545266236967!2d80.2226762757666!3d13.089391387236867!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a52642e68adc059%3A0x44809bfe043deede!2sOrange%20Office%20Technologies%20Pvt%20Ltd!5e0!3m2!1sen!2sin!4v1746264921346!5m2!1sen!2sin" width="100%" height="400" style={{
          border: 0
        }} allowFullScreen={true} loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Orange Office Technologies Location" className="rounded-xl" />
        </div>
