...
export const GradientBackground = ({
  ...
  return <div ref={ref} className={cn("relative overflow-hidden", className)}>
      <div style={gradientStyle} className="bg-gray-950" />
      <div style={gradientStyle} className="bg-stone-500" />
