...
export const Hero = ({
  backgroundImages = ["/1.png", "/2.png", "/4.png", "/5.png","/3.png"],
}: HeroProps) => {
  const settings = {
    autoplay: true,
    autoplaySpeed: 4000,
    ...
    <section className="relative overflow-hidden min-h-[90vh] md:min-h-[100vh] flex flex-col justify-between bg-white">
      ...
      <div className="container mx-auto px-4 relative z-10 md:py-16 flex flex-col justify-between h-full py-0">
        <div className="flex-grow flex items-center mx-0 md:my-[87px] my-[35px]">
          <div className="text-center lg:text-left max-w-3xl mx-auto lg:mx-0 my-[24px] bg-white/80 backdrop-blur-md rounded-xl p-6 shadow-lg">
            ...
            <div className="flex flex-wrap gap-3 md:gap-4 justify-center lg:justify-start">
              <Button
                size="lg"
                className="bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white shadow-lg hover:shadow-xl transition-all duration-300 rounded-xl border-0 text-sm md:text-base"
              >
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-2 border-orange-400 hover:bg-orange-50 rounded-xl text-sm md:text-base text-orange-700"
              >
