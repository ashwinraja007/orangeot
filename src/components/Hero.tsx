  ...
  return <section className="relative overflow-hidden min-h-[90vh] md:min-h-[100vh] flex flex-col justify-between bg-white">
      ...
      <div className="container mx-auto px-4 relative z-10 flex flex-col justify-between h-full">
        <div className="flex-grow flex items-center">
          <div className="text-center lg:text-left max-w-3xl mx-auto lg:mx-0 backdrop-blur-md rounded-xl p-6 shadow-lg md:my-[5px] my-[28px] bg-slate-50">
            ...
            <h1 className="font-heading text-3xl sm:text-4xl md:text-5xl mb-4 md:mb-6 leading-tight tracking-tight font-bold text-gray-950">
              Powering{" "}
