      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-gray-600 mb-4">Orange Office Technologies Pvt Ltd is a specialized KPO provider catering exclusively to the global shipping, freight management, and third-party logistics (3PL) industries. With a strong foundation in logistics domain expertise and digital innovation, OOT delivers integrated operational support and IT solutions that streamline processes, enhance productivity, and drive sustainable growth across the logistics value chain.</p>
