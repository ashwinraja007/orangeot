...
const Careers = () => {
  ...
  return <div className="min-h-screen flex flex-col">
      ...
      <section className="pt-32 pb-20 bg-gradient-to-br from-primary/10 to-accent/10">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 rounded-full bg-orange-400/20 text-orange-600 mb-6 animate-fade-in text-sm font-medium px-4 py-2">
            ...
            <p className="text-xl text-gray-600 mb-8 animate-fade-in">
              Be part of a team that's reshaping the future of logistics technology
            </p>
            <div className="flex justify-center">
              <img 
                src="https://images.unsplash.com/photo-1552581234-26160f608093?auto=format&fit=crop&w=1200&h=400&q=80" 
                alt="Team working together" 
                className="rounded-xl shadow-lg w-full object-cover h-64 animate-fade-in"
              />
            </div>
          </div>
        </div>
      ...
      {/* Why Join Us - Enhanced with Better Visuals */}
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="font-heading font-bold text-3xl mb-8">Why Join Orange Office Technologies?</h2>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-6 shadow-md hover:shadow-lg transition-all duration-300 text-center">
              ...
              <p className="text-gray-600">Work alongside talented professionals who are passionate about making a difference in the logistics industry</p>
            </div>
            
            <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl p-6 shadow-md hover:shadow-lg transition-all duration-300 text-center">
              <div className="mx-auto w-16 h-16 flex items-center justify-center bg-amber-100 rounded-full mb-6">
                <GraduationCap className="h-8 w-8 text-amber-600" />
              </div>
              <h3 className="font-bold text-lg mb-3">Growth & Learning</h3>
              <p className="text-gray-600">Continuous professional development opportunities and clear career advancement paths</p>
            </div>
            
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 shadow-md hover:shadow-lg transition-all duration-300 text-center">
              ...
              <p className="text-gray-600">Flexible work environment that respects your personal time and overall wellbeing</p>
            </div>
          </div>
        </div>
      </section>

      {/* Enhanced Current Openings with More Details */}
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-4">
          <h2 className="font-heading font-bold text-3xl mb-6 text-center">Current Openings</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {jobs.map((job, index) => (
              <Card key={index} className="group hover:shadow-xl transition-all duration-300 border-none animate-fade-in" style={{
                ...
                <CardContent className="p-8 rounded-lg bg-white">
                  <div className="space-y-6">
                    ...
                    <p className="text-gray-600 border-t border-gray-100 pt-4">{job.description}</p>
                    
                    <div>
                      <p className="text-sm font-medium text-gray-700 mb-2">Required skills:</p>
                      <div className="flex flex-wrap gap-2">
                        {job.skills.map((skill, i) => (
                          <span key={i} className="bg-slate-100 px-2 py-1 rounded-md text-xs text-gray-700">
                            {skill}
                          </span>
                        ))}
                      </div>
      ...
      {/* Application Process Section - New Section */}
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="font-heading font-bold text-3xl mb-12 text-center">Our Application Process</h2>
          
          <div className="max-w-4xl mx-auto">
            <div className="relative">
              {/* Timeline line */}
              <div className="absolute left-5 lg:left-1/2 transform lg:-translate-x-1/2 top-0 bottom-0 w-1 bg-orange-200"></div>
                ...
                {[
                  ...
                  <div key={index} className="relative flex flex-col lg:flex-row gap-6 lg:gap-0">
                    ...
                    <div className={`lg:w-1/2 ml-16 lg:ml-0 ${index % 2 === 0 ? 'lg:pr-12 lg:text-right' : 'lg:pl-12 lg:ml-auto'}`}>
                      <div className="bg-slate-50 p-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-300">
      ...
      <section className="py-16 bg-gradient-to-r from-orange-500 to-amber-500 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join our team and be part of creating innovative solutions for the logistics industry
          </p>
