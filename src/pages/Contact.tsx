          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="animate-fade-in delay-100">
              <Card className="border-none shadow-lg">
                <CardContent className="p-8">
                  <h2 className="font-heading font-bold text-2xl mb-6 text-gray-800">Send Us a Message</h2>
            ...
            <div className="space-y-8 animate-fade-in delay-150">
              ...
              <div className="mt-8 animate-fade-in delay-200">
                <h2 className="font-heading font-bold text-2xl mb-6">Find Us On Map</h2>
                <MapComponent locations={officeLocations} className="h-[450px]" />
              </div>
            </div>
          </div>
        </div>
