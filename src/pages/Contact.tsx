  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-white to-orange-50">
      ...
      <GradientBackground variant="primary" intensity="medium" animated={true} className="pt-32 pb-20">
        <section className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className={cn("inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 text-primary mb-6 transform transition-all duration-700", 
              isPageLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5")}>
              <ContactIcon size={16} />
              <span className="font-medium">Get in Touch</span>
            </div>
            
            <h1 className={cn("font-heading font-bold text-4xl md:text-5xl lg:text-6xl mb-6 bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 bg-clip-text text-transparent transform transition-all duration-700", 
              isPageLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5")}>
              Let's Start a Conversation
            </h1>
            
            <p className={cn("text-xl mb-8 text-gray-700 max-w-2xl mx-auto transform transition-all duration-700 delay-100", 
              isPageLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5")}>
      ...
      <section className="py-20 -mt-10 relative z-10">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
            {/* Contact Form - Wider */}
            <div className={cn("lg:col-span-3 transform transition-all duration-700 delay-200", 
              isPageLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5")}>
            ...
            <div className={cn("lg:col-span-2 space-y-8", isPageLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5")}>
              ...
              <Card className="border-none shadow-lg overflow-hidden bg-gradient-to-br from-orange-500 to-orange-600 text-white">
                <CardContent className="p-6">
                  ...
                  <p className="text-white/90 mb-4">Follow us on social media to stay updated with our latest news and offers</p>
              ...
              <Card className="border-none shadow-lg hover:shadow-xl transition-all duration-500">
                ...
                <CardContent className="p-6">
                  <h3 className="font-bold text-lg mb-4 text-gray-800">Need Immediate Assistance?</h3>
      ...
      <section className="py-16 bg-white relative">
        ...
        <div className="relative w-full h-[500px] overflow-hidden shadow-2xl rounded-none md:rounded-lg mx-auto max-w-7xl">
          <iframe 
      ...
      <section className="py-16 bg-orange-50/50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="font-heading font-bold text-3xl md:text-4xl mb-4 text-gray-800">Frequently Asked Questions</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            {[
              {
                q: "What services does Orange Office Technologies offer?",
                a: "We provide comprehensive logistics solutions including supply chain management, transport optimization, warehouse management, and custom software development for logistics operations."
              },
              {
                q: "How can I schedule a consultation?",
                a: "You can schedule a consultation by filling out our contact form, calling our office directly, or sending us an email. Our team will get back to you within 24 hours."
              },
              {
                q: "Do you offer custom software solutions?",
                a: "Yes, we specialize in developing tailored software solutions to meet the specific needs of your logistics operations, integrating with your existing systems."
              },
              {
                q: "What areas do you serve?",
                a: "We primarily serve businesses across India, with a strong presence in South India. However, our digital solutions can be implemented worldwide."
              }
            ].map((faq, index) => (
              <Card key={index} className="border-none shadow-lg hover:shadow-xl transition-all duration-500 overflow-hidden">
                <CardContent className="p-6">
      ...
      <section className="py-16 bg-gradient-to-r from-orange-600 to-orange-500 text-white">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            <h2 className="font-heading font-bold text-3xl md:text-4xl mb-6">Ready to Transform Your Logistics?</h2>
            <p className="text-lg mb-8 text-white/90">Get in touch today and discover how our solutions can drive efficiency and growth for your business</p>
            <Button className="bg-white text-orange-600 hover:bg-orange-50 px-8 py-6 h-auto text-lg font-medium">
              Contact Us Now
            </Button>
          </div>
        </div>
