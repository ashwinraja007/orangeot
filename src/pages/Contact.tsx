      ...
      <section className="py-16 bg-white relative">
        <div className="container mx-auto px-4 mb-12">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-lg text-gray-600">Find us at our convenient office location in Chennai</p>
          </div>
        </div>
        ...
        <div className="relative w-full h-[500px] overflow-hidden shadow-2xl rounded-none md:rounded-lg mx-auto max-w-7xl">
          ...
          border: 0
        }} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Orange Office Technologies Location" className="absolute inset-0" />
        </div>
      </section>
