...
const Index = () => {
  ...
  return <div className="min-h-screen flex flex-col">
      ...
      <section className="py-24 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden bg-slate-500">
        ...
        <div className="container mx-auto px-4 relative z-10 bg-slate-200">
