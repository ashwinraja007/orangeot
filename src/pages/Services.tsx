      ...
      <section className="py-16 -mt-10 bg-white relative z-10">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service, index) => <Card key={index} className="group hover:shadow-2xl transition-all duration-500 animate-fade-in overflow-hidden border-none rounded-2xl h-full" style={{
      ...
      <GradientBackground className="py-16" variant="accent" intensity="strong" animated={true}>
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="font-heading font-bold text-2xl md:text-3xl lg:text-4xl mb-6 text-gradient bg-gradient-to-r from-white to-gray-100 bg-clip-text text-slate-950">
              Ready to Transform Your Operations?
            </h2>
            <p className="text-lg mb-8 max-w-2xl mx-auto text-gray-950">
